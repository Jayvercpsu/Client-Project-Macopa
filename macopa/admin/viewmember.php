                                ...
                                <tr>
                                    ...
                                    <td style="white-space: nowrap;">
                                        ...
                                        <style>
                                            ...
                                            .view-family-link::after {
                                                content: "View Family Member";
                                                position: absolute;
                                                bottom: -30px;
                                                left: 50%;
                                        ...
                                        <!-- View family member link -->
                                        <a href="viewfamilymember.php?id=<?php echo htmlspecialchars($row['member_id']); ?>" class="view-family-link">
                                            <i class="fas fa-eye"></i>
                                        </a>

                                        <!-- Edit button -->
                                        <button class="btn btn-warning btn-sm fas fa-edit toggle-edit" data-id="<?php echo htmlspecialchars($row['member_id']); ?>"></button>
                                        <!-- Delete form -->
