                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                            ...
                            $queryStr = "SELECT * FROM household_members WHERE purok = 'Purok 2' AND YEAR(date) = '$selectedYear' 
                                         AND (household_id LIKE '%$search_term%' OR First_name LIKE '%$search_term%' 
                                         OR Last_name LIKE '%$search_term%' OR purok LIKE '%$search_term%' OR gender LIKE '%$search_term')";
